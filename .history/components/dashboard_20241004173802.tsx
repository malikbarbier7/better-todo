...
import { format, formatDistanceToNow, isToday, parseISO, isPast, isFuture, isValid } from "date-fns"
...
export function Dashboard() {
  ...
  const formatDueDate = (date: string) => {
    try {
      ...
      return format(dueDate, "PPP"); // Fallback to a standard date format
    } catch (error) {
                        ...
                        <Popover open={isDatePickerOpen} onOpenChange={setIsDatePickerOpen}>
                          <PopoverTrigger asChild>
                            ...
                            >
                              ...
                              {newTaskDueDate ? formatDueDate(newTaskDueDate.toISOString()) : <span>Set due date</span>}
                            </Button>
                          </PopoverTrigger>
