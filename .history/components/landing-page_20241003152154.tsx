            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Streamline your tasks with our minimalist to-do app. Clean, efficient, and designed for productivity.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-center text-gray-500 dark:text-gray-400">Quickly add new tasks with just a few taps.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  <CheckCircle className="h-12 w-12 text-gray-600 dark:text-gray-400 mb-2" />
                  <h3 className="text-xl font-bold">Satisfying Completion</h3>
                  <p className="text-center text-gray-500 dark:text-gray-400">Mark tasks as done with a simple gesture.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-center text-gray-500 dark:text-gray-400">Set up repeating tasks for regular activities.</p>
                </CardContent>
              </Card>
            </div>
          </div>
