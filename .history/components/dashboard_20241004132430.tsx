...
import { CalendarDays, CheckCircle, Circle, ListTodo, PlusCircle, X, ChevronDown, TrendingUp, Calendar as CalendarIcon, Trash2 } from "lucide-react"
...
export function Dashboard() {
  ...
  const filteredTasks = React.useMemo(() => {
    if (taskFilter === 'deleted') {
      return deletedTasks.sort((a, b) => b.id - a.id); // Trie les tâches supprimées par ID décroissant
    }
  ...
  }, [tasks, activeTab, taskFilter, deletedTasks]);
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-start mt-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        size="sm"
                        variant={taskFilter === 'deleted' ? 'default' : 'outline'}
                      ...
                      <Button
                        size="sm"
                        variant="destructive"
                        onClick={handleCleanCompletedTasks}
                      >
