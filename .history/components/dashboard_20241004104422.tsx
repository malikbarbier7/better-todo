          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="flex flex-col">
                <div className="mb-4 flex justify-between items-center bg-gray-100 p-2 rounded-md">
                  <TabsList className="flex-grow flex flex-wrap justify-start bg-transparent">
                    {tabs.map((tab) => (
                      <TabsTrigger key={tab} value={tab} className="mr-2 mb-1 text-sm">
                        {tab}
                        {tab !== 'All' && (
                          <Button
                            variant="ghost"
                  ...
                  <div className="flex items-center space-x-1 ml-2">
                    ...
                    />
                    <Button onClick={handleAddTab} size="sm" className="h-7 text-xs px-2">
                      Add
                    </Button>
                  </div>
                </div>
